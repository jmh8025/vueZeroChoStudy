    ...
    <v-app>
        <nav>
            <v-toolbar dark color="red">
                <v-toolbar-title>
                    <nuxt-link to="/">
                        <v-img src="https://kw.mncapro.com/upload/eems/logo/sookmyung_m.ac.kr/2019/99/logo.png" width="70%" height="70%"></v-img>
                    </nuxt-link>
                </v-toolbar-title>
                <v-spacer></v-spacer>
                <v-toolbar-items>
        ...
        <div>{{name}}</div>
        <v-btn color="success" @click="onChangeName">바이바이</v-btn>
        <v-row>
            <v-col cols="12" md="4">
                <login-form/>
            </v-col>
